...
public class ProblemDay2b implements ProblemDay<Integer> {
    ...
    private static final Map<Set<String>, String> PLAY = new HashMap<Set<String>, String>() {{
        put(new HashSet<String>() {{ add("A"); add("X"); }}, "Z");  // Rock / lose = scissors
        put(new HashSet<String>() {{ add("A"); add("Y"); }}, "X");  // Rock / draw = rock
        put(new HashSet<String>() {{ add("A"); add("Z"); }}, "Y");  // Rock / win = paper
        put(new HashSet<String>() {{ add("B"); add("X"); }}, "X");  // Paper / lose = rock
        put(new HashSet<String>() {{ add("B"); add("Y"); }}, "Y");  // Paper / draw = paper
        put(new HashSet<String>() {{ add("B"); add("Z"); }}, "Z");  // Paper / win = scissors
        put(new HashSet<String>() {{ add("C"); add("X"); }}, "Y");  // Scissors / lose = paper
        put(new HashSet<String>() {{ add("C"); add("Y"); }}, "Z");  // Scissors / draw = scissors
        put(new HashSet<String>() {{ add("C"); add("Z"); }}, "X");  // Scissors / win = rock
    }};
